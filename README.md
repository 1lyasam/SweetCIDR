...
34.**.**.43	172.31.38.122	      i-052*************	                      sg-0bc*************	  launch-wizard created ...	              22	tcp
18.**.**.6	172.31.29.82	      i-061*************	                      sg-055*************	  launch-wizard-1 created ...	            80	tcp
18.**.**.6	172.31.29.82	      i-061*************	                      sg-055*************	  launch-wizard-1 created ...	            3389	tcp
34.**.**.125	172.31.31.3	      i-042*************	                      sg-061*************	  launch-wizard-1 created ...	            22	tcp
34.**.**.125	172.31.31.3	      i-042*************	                      sg-061*************	  launch-wizard-1 created ...	            8000	tcp
```
